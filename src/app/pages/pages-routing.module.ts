...
const routes: Routes = [
    ...
    { path: 'articles/create', component: ArticleEditPage, canActivate: [ authorizationGuard ], title: 'Vernissage - Create article' },
    ...
    { path: 'status-activity-pub-events', component: StatusActivityPubEventsPage, canActivate: [ authorizationGuard ], title: 'Vernissage - Activity Pub events'},
    { path: 'status-activity-pub-events/:eventId/items', component: StatusActivityPubEventItemsPage, canActivate: [ authorizationGuard ], title: 'Vernissage - Activity Pub event recipients'},
    ...
    { path: 'statuses/:id/events', component: StatusEventsPage, canActivate: [ authorizationGuard ], title: 'Vernissage - Status events' },
    { path: 'statuses/:id/events/:eventId/items', component: StatusEventItemsPage, canActivate: [ authorizationGuard ], title: 'Vernissage - Event recipients' },
