...
@Component({
    selector: 'app-lens',
    templateUrl: './lens.page.html',
    styleUrls: ['./lens.page.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [MatIcon, GalleryComponent]
})
export class LensPage extends ReusableGalleryPageComponent implements OnInit, OnDestroy {
    protected isReady = signal(false);
    protected lens = signal('');
    ...
    override async ngOnInit(): Promise<void> {
        ...
        this.routeParamsSubscription = this.activatedRoute.params.subscribe(async params => {
            ...
            this.lens.set(params['lens'] as string);
    ...
    private async loadFirstStatusesSet(): Promise<void> {
        const downloadedStatuses = await this.timelineService.lens(this.lens(), undefined, undefined, undefined, undefined);
        downloadedStatuses.context = ContextTimeline.lens;
        downloadedStatuses.lens = this.lens();
