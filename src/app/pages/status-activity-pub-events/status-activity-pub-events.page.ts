...
@Component({
    selector: 'app-status-activity-pub-events',
    templateUrl: './status-activity-pub-events.page.html',
    styleUrls: ['./status-activity-pub-events.page.scss'],
    animations: fadeInAnimation,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})
export class StatusActivityPubEventsPage extends ResponsiveComponent implements OnInit, OnDestroy {
