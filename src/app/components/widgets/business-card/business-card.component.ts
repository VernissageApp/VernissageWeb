...
import { NgStyle, NgOptimizedImage, UpperCasePipe } from '@angular/common';
...
@Component({
    ...
    imports: [NgStyle, NgOptimizedImage, MatCard, MatCardContent, MatButton, UpperCasePipe, TranslatePipe]
})
